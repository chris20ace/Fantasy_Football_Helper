...
The lineup engine chooses the highest-scoring legal combination, respecting eligibility, injuries, reserves, taxi slots, game locks and unknown data. Matchup analysis scores both submitted lineups and the suggested lineup with the same provider values. Whole-game projections stay separate from actual points; they are not a win probability.
